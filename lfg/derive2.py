...
def _bounce_forward(recode_weight, recode_bias, layer1_weight, layer1_bias,
    ...
    h2_ = h1 @ layer3_weight.T + layer3_bias
    h2 = np.maximum(h2_, alpha*h2_) * h1 + h1

    y1_ = h2 @ dec_0_weight.T + dec_0_bias
    y1 = np.maximum(y1_, alpha*y1_)
...
def _aero_forward(recode_weight, recode_bias, layer1_weight, layer1_bias, 
    ...
    y_ = h2 @ dec_0_weight.T + dec_0_bias
    y = np.maximum(y_, alpha*y_)
